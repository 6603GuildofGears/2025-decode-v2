...
public class Blue_Back extends OpMode {
    ...
    // ========== Turret auto-aim ==========
    private static final double TURRET_TARGET_DEG = 76.0;  // turret angle for blue back
    ...
    // ========== Shooter tuning ==========
    private static final double AUTO_SHOOT_RPM = 3275;
    private static final double AUTO_HOOD_POS  = 0.05;
    ...
    private final Pose shootPose = new Pose(57, 17, Math.toRadians(120));
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            ...
            case DRIVE_INTAKEPOSE_TO_INTAKE1:
                if (!pathStarted) {
                    follower.followPath(driveIntakePoseToIntake1, 0.25, true);
                    pathStarted = true;
                }
                wantIntakeMotor = true;
                if (pathStarted && !follower.isBusy()) {
            ...
            case DRIVE_INTAKE1_TO_SHOOTPOSE:
                if (!pathStarted) {
                    follower.followPath(driveIntake1ToShootPose, 1, true);
                    pathStarted = true;
                }
                wantIntakeMotor = true;
            ...
            case DRIVE_INTAKE2_TO_SHOOTPOSE:
                if (!pathStarted) {
                    follower.followPath(driveIntake2ToShootPose, 1, true);
                    pathStarted = true;
                }
                wantIntakeMotor = true;
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Blue Back Auto — Ready");
