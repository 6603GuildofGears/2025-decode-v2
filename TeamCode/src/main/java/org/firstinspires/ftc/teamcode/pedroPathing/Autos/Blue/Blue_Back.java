...
public class Blue_Back extends OpMode {
    ...
    private final Pose intake1 = new Pose(24, 36, Math.toRadians(180));       // Intake 1 position
    private final Pose intake1Pose2 = new Pose(21, 36, Math.toRadians(180));  // Intake 1 waypoint 2
    private final Pose intake1Pose3 = new Pose(18, 36, Math.toRadians(180));  // Intake 1 waypoint 3
    private final Pose intake2 = new Pose(9.5, 9.5, Math.toRadians(180));     // Intake 2 position
    private final Pose intake2Pose1 = new Pose(6.5, 9.5, Math.toRadians(180)); // Intake 2 waypoint 1
    private final Pose intake2Pose2 = new Pose(3.5, 9.5, Math.toRadians(180)); // Intake 2 waypoint 2
    private final Pose intake2Pose3 = new Pose(1, 9.5, Math.toRadians(180));   // Intake 2 waypoint 3
    private final Pose endPose = new Pose(12, 36, Math.toRadians(180));       // End/park position
