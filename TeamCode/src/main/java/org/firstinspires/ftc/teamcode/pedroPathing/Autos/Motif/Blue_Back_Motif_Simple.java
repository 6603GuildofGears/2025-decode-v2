...
/**
 * Simplified Blue Back Auto - Just shoot preload and move to end position
 */
@Autonomous(name = "Blue Back SIMPLE", group = "Blue")
public class Blue_Back_Motif_Simple extends OpMode {
    ...
    // Turret
    private static final double TURRET_TARGET_DEG = 120;
    private static final double TURRET_MOTIF_SCAN_DEG = 150;
    ...
    // Simple poses - start, shoot, end only
    ...
    private final Pose endPose = new Pose(40, 12, Math.toRadians(180));
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            case DRIVE_START_TO_SHOOT:
                ...
                telemetry.addLine("Driving to shoot...");
